      ...
      <div className='Upload_file'>
        <div className='main'>
          <div className='local'>
            ...
            <input type='file' id='input-file' onChange={this.fileChange} accept='image/*' style={{ display: 'none' }}></input>
          </div>
          <div className='url'>
            <label>Load image with URL</label>
            <form id='imgload' onSubmit={this.handleSubmit}>
            url : <input name='url' value={this.state.url} onChange={this.handleChange} placeholder='https://example.com/example.jpg'></input>
